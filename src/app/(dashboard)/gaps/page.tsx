              ...
              >
                    ...
                    <div className="space-y-1.5 flex-1 min-w-0">
                      ...
                      {gap.cluster && (
                        <Badge 
                          variant="outline" 
                          style={{
                            borderColor: `${gap.cluster.color}35`,
                            backgroundColor: `${gap.cluster.color}15`,
                      ...
                      <h3 className="text-lg font-bold text-white leading-snug">{gap.gapTitle}</h3>
                    </div>
                ...
                <CardContent className="pt-0 pb-6 border-t border-slate-900/60 mt-3 pt-4">
                  ...
                  <Button 
                    ...
                    className="mt-4 text-indigo-400 hover:text-indigo-300 hover:bg-slate-900/40 p-0 h-auto"
                  >
                    {isExpanded ? (
